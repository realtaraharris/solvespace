...
GroupsListView::GroupsListView(BRect frame, BMessage *selectionChangeMessage) : SimpleListView(frame, selectionChangeMessage) {}

GroupsListView::GroupsListView(BRect frame, const char *name,
                               BMessage *selectionChangeMessage,
                               list_view_type type, uint32 resizingMode,
                               uint32 flags) : SimpleListView(frame, name, selectionChangeMessage, type, resizingMode, flags) {}
