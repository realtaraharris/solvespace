...
AppToolbar::AppToolbar (BRect rect, BSize toolbarIconSize)
  ...
  cubicSplineToolButton =
      MakeButton (toolbarIconSize, cubicSplineToolIcon,
                  new BMessage (CUBIC_SPLINE_TOOL_BTN_CLICKED), "Sketch cubic Bezier spline (B)");
  datumPointToolButton =
      MakeButton (toolbarIconSize, datumPointToolIcon, new BMessage (DATUM_POINT_TOOL_BTN_CLICKED),
                  "Sketch point (P)");
  constructionToolButton =
      MakeButton (toolbarIconSize, constructionToolIcon,
