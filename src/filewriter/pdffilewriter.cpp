...
void PdfFileWriter::Background(RgbaColor color) {
  ...
  fprintf(f,
          ...
          "%.3f %.3f l\r\n"
          "b\r\n",
          color.redF(), color.greenF(), color.blueF(), color.redF(), color.greenF(), color.blueF(),
          MmToPts(sw), MmToPts(0), MmToPts(0), MmToPts(width), MmToPts(0), MmToPts(width),
          MmToPts(height), MmToPts(0), MmToPts(height));
}
