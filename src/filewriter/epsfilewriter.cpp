...
void EpsFileWriter::Background(RgbaColor color) {
  ...
  fprintf(f,
          ...
          "    closepath\r\n"
          "gsave fill grestore\r\n",
          color.redF(), color.greenF(), color.blueF(), MmToPts(0), MmToPts(0), MmToPts(width),
          MmToPts(0), MmToPts(width), MmToPts(height), MmToPts(0), MmToPts(height));
...
void EpsFileWriter::StartPath(RgbaColor strokeRgb, double lineWidth, bool filled, RgbaColor fillRgb,
                              hStyle hs) {
  fprintf(f, "newpath\r\n");
