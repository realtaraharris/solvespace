...
namespace SolveSpace {
  ...
  void AggRenderer::OutputBezier(const SBezier &b, hStroke hcs) {
    ...
    if (b.deg == 1) {
      ...
      agg::render_scanlines_aa_solid(pf, sl, rb,
                                     agg::rgba8(color.red, color.green, color.blue, color.alpha));
      ...
      curve.init(b.ctrl[1].x, b.ctrl[1].y, b.ctrl[2].x, b.ctrl[2].y, b.ctrl[3].x, b.ctrl[3].y);
