...
#define mView (&SolveSpaceUI::MenuView)
#define mEdit (&SolveSpaceUI::MenuEdit)
#define mClip (&SolveSpaceUI::MenuClipboard)
#define mReq  (&SolveSpaceUI::MenuRequest)
#define mCon  (&SolveSpaceUI::MenuConstrain)
#define mFile (&SolveSpaceUI::MenuFile)
#define mGrp  (&SolveSpaceUI::MenuGroup)
...
void GraphicsWindow::PopulateRecentFiles() {
    ...
    PopulateMenuWithPathnames(linkRecentMenu, SS.recentFiles, [](const Platform::Path &path) {
        SolveSpaceUI::MenuGroup(Command::GROUP_LINK, path);
    });
}
